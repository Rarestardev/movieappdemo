...
public class CardViewAdapterLarger extends RecyclerView.Adapter<CardViewAdapterLarger.myViewHolder>{
    ...
    public CardViewAdapterLarger(List<movie_model> data, Context context) {
        this.data = data;
    ...
    public myViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        view = LayoutInflater.from(parent.getContext()).inflate(R.layout.card_view2,parent,false);
