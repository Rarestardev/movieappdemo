...
public class ShowListUserRate extends AppCompatActivity implements View.OnClickListener {
    RecyclerView recyclerView_userRate;
    ImageView ic_back,ic_search;
    RecyclerView.LayoutManager layoutManager;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_show_list_user_rate);
    ...
    private void init(){
        layoutManager = new GridLayoutManager(ShowListUserRate.this,MainActivity.screenSize);
        recyclerView_userRate = findViewById(R.id.recyclerView_userRate);
        recyclerView_userRate.setLayoutManager(layoutManager);
    ...
    private void processDate(){
        ...
        call.enqueue(new Callback<List<movie_model>>() {
            ...
            public void onFailure(@NonNull Call<List<movie_model>> call, @NonNull Throwable t) {
                Log.d("ShowListUserRate","error",t);
            }
        });
    }
}